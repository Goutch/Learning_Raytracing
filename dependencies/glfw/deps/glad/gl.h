 ...
 *
 * Commandline:
 *    --api='graphics:compatibility=3.3' --extensions='GL_ARB_multisample,GL_ARB_robustness,GL_KHR_debug' c
 *
 * Online:
 *    http://glad.sh/#api=graphics%3Acompatibility%3D3.3&extensions=GL_ARB_multisample%2CGL_ARB_robustness%2CGL_KHR_debug&generator=c&options=
 *
 */
...
#ifdef __gl_h_
    #error OpenGL header already included (API: graphics), remove previous include!
#endif
#define __gl_h_ 1
